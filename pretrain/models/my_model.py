...
class My_Model(nn.Module):
    ...
    def forward(self, data_item):
        ...
        sent_embed = self._filter_pad_embed(sent_embed, bz, col_num, cell_len, data_item["input_len_list"])
        ...
        if "2" in self.args.task_list:
            discriminator_task_res, discriminator_task_loss = self.discriminator_task(
                sent_embed, data_item["discriminator_input_index"], bz, col_num, cell_len)
        else:
    ...
    def discriminator_task(self, sent_embed, discriminator_label, bz, col_num, cell_len):
    ...
    def _filter_pad_embed(self, sent_embed, bz, col_num, cell_len, input_len_list):
